...
export const translations = {
  ...
  es: {
    ...
    load_sample: "Cargar RFP de Ejemplo",
    destination: "Destino",
    incoterm: "Incoterm",
    payment: "Pago",
    line: "Línea",
    ...
    project_info: "Información de RFP",
    project_name: "Nombre de RFP",
    project_description: "Descripción de RFP (Contexto)",
    generate_summary: "Generar Resumen",
    ai_summary_label: "Resumen Generado por IA",
    rfp_details: "Detalles RFP",
    ...
    save_draft: "Guardar",
    save_success: "¡RFP guardada con éxito!",
    archive_project: "Archivar RFP",
    restore_project: "Restaurar RFP",
    created: "Creado",
    status: "Estado",
  ...
  zh: {
    ...
    project_info: "RFP 信息",
    project_name: "RFP 名称",
    project_description: "RFP 描述（供应商参考）",
    ...
    nav_archived: "已归档",
    save_draft: "保存草稿",
    save_success: "RFP 保存成功！",
    archive_project: "归档 RFP",
    restore_project: "还原 RFP",
    created: "创建时间",
    status: "状态",
    status_draft: "草稿",
    status_sent: "已发送",
