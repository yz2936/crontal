...
export const translations = {
  en: {
    ...
    chat_placeholder: "Ex: 50 pcs 304L tubes, 2 inch OD, 6m long...",
    send: "Send",
  ...
  es: {
    ...
    chat_placeholder: "Ej: 50 pzas tubos 304L, 2 pulgadas DE, 6m largo...",
    send: "Enviar",
  ...
  zh: {
    ...
    chat_placeholder: "例如：50件 304L 管，2英寸外径，6米长...",
    send: "发送",
    live_preview: "实时请求预览",
    download_pdf: "下载 PDF",
    share_link: "分享链接",
